...
public abstract class IntegrationTest {
  ...
  private static final String webGoatPort = Objects.requireNonNull(System.getProperty("webgoatport"));

  @Getter
  private static final String webWolfPort = Objects.requireNonNull(System.getProperty("webwolfport"));

  private static final boolean useSSL = false;
  private static final String webgoatUrl =
      (useSSL ? "https:" : "http:") + "//localhost:" + webGoatPort + "/WebGoat/";
  private static final String webWolfUrl =
